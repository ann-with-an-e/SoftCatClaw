		...
		"entries": [
			{
				"classification": "UNCLASSIFIED",
				"metadata": {
					"table1- t1": "columns- c1, c2, c3",
					"table2- t2": "columns- c1, c2, c3",
					"table3- t3": "columns- c1, c2, c3"
				},
				"operatingSystem": "Android",
				"priority": 0,
				"source": "User Generated",
				"type": "Database",
				"value": "data/data/app.com/database.db"
			},
			{
				"classification": "UNCLASSIFIED",
				"metadata": {
				...
				"source": "User Generated",
				"type": "Database",
				"value": "data/data/app.com/database2.db"
			}
		],
		"name": "ApplicationName3",
		"operatingSystem": "Android",
		"operatingSystemVersion": "Unspecified",
		"source": "User Generated",
		"type": "Application",
		"version": "2.5"
	},
